  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      <style jsx>{`
        ...
        .cat-card:hover { border-color: rgba(255,255,255,0.2); background: rgba(255,255,255,0.05); }
        .cat-card.active { border-color: var(--accent-primary); background: rgba(255, 107, 0, 0.1); color: var(--accent-primary); font-weight: bold;}
        .w-full { width: 100%; }
